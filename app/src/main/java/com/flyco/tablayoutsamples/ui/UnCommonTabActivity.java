...
import com.flyco.tablayout.UnCommonTabLayout;
import com.flyco.tablayout.listener.CustomTabEntity;
import com.flyco.tablayout.listener.ImageTabEntity;
...
public class UnCommonTabActivity extends AppCompatActivity {
    ...
    private UnCommonTabLayout mTabLayout_1;
    private UnCommonTabLayout mTabLayout_2;
    private UnCommonTabLayout mTabLayout_3;
    private UnCommonTabLayout mTabLayout_4;
    private UnCommonTabLayout mTabLayout_5;
    private UnCommonTabLayout mTabLayout_6;
    private UnCommonTabLayout mTabLayout_7;
    private UnCommonTabLayout mTabLayout_8;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_un_common_tab);
        ...
        for (int i = 0; i < mTitles.length; i++) {
            ImageTabEntity imageTabEntity = new ImageTabEntity(mTitles[i], "http://file.inicoapp.com/giftresource/vip@3x.png", "http://file.inicoapp.com/giftresource/lv2@3x.png");
            imageTabEntity.setSelectedIcon(mIconSelectIds[i]);
            imageTabEntity.setUnSelectedIcon(mIconUnselectIds[i]);
            mTabEntities.add(imageTabEntity);
        }
