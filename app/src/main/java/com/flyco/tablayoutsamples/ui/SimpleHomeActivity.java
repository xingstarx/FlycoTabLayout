...
public class SimpleHomeActivity extends AppCompatActivity {
    ...
    private final String[] mItems = {"SlidingTabLayout", "CommonTabLayout", "SegmentTabLayout", "SlidingTabLayout2", "SlidingImageTabLayout","UnCommonTabActivity"};
    private final Class<?>[] mClasses = {SlidingTabActivity.class, CommonTabActivity.class,
            SegmentTabActivity.class, SlidingTabActivity2.class, SlidingImageTabActivity.class,UnCommonTabActivity.class};
