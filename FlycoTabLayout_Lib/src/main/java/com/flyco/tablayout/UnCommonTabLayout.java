 ...
 */
public class UnCommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public UnCommonTabLayout(Context context) {
        this(context, null, 0);
    }

    public UnCommonTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UnCommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            if (mIconVisible) {
                if (iconH <= 0) {
                    if (TextUtils.isEmpty(mTabEntitys.get(position).getTabSelectedIconByString()) || TextUtils.isEmpty(mTabEntitys.get(position).getTabUnSelectedIconByString())) {
                        ...
                        iconH = ((Bitmap) bitmapResource.get(position).get(TAB_SELECTED)).getHeight();
                    }
                }
                margin = mIconMargin;
            }
